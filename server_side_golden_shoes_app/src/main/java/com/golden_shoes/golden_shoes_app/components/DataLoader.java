...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        StockItem item18 = new StockItem(6, "brown", birkenstockSandal, goldenShoes);
        stockItemRepository.save(item18);
        ...
        StockItem item19 = new StockItem(7, "black", docMartenBoots, goldenShoes);
        stockItemRepository.save(item19);
        goldenShoes.addStock(item19);
        StockItem item20 = new StockItem(7, "black", docMartenBoots, goldenShoes);
        stockItemRepository.save(item20);
